...
import 'package:takeout_watch/pages/connect.dart';
import 'package:takeout_watch/pages/home.dart';
...
class WatchApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var appTheme = ThemeData.localize(
    ...
    appTheme = appTheme.copyWith(
      listTileTheme: appTheme.listTileTheme.copyWith(
        titleTextStyle: appTheme.textTheme.bodyMedium?.copyWith(
          overflow: TextOverflow.ellipsis,
        ),
        subtitleTextStyle: appTheme.textTheme.bodySmall?.copyWith(
          overflow: TextOverflow.ellipsis,
        ),
      ),
