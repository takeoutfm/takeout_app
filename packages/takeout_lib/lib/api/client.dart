...
class TakeoutClient implements ClientProvider {
  ...
  /// GET /api/index
  @override
  Future<IndexView> index({Duration? ttl}) async => _retry<IndexView>(
  ...
  /// GET /api/home
  @override
  Future<HomeView> home({Duration? ttl}) async => _retry<HomeView>(
  ...
  /// GET /api/artists
  @override
  Future<ArtistsView> artists({Duration? ttl}) async => _retry<ArtistsView>(
  ...
  Future<WantListView> artistWantList(int id, {Duration? ttl}) async =>
      _retry<WantListView>(
        () => _getJson('/api/artists/$id/wantlist', ttl: ttl)
  ...
  Future<Spiff> playlist({
    ...
    if (id != null) {
      ...
      return spiff(
        '/api/playlists/${Uri.encodeComponent(name)}/playlist',
        ttl: ttl,
      );
    } else {
  ...
  Future<PlaylistsView> playlists({Duration? ttl}) async =>
      _retry<PlaylistsView>(
        () => _getJson('/api/playlists', ttl: ttl)
  ...
  ) async => _retry<PatchResult>(() {
    return _patchJson('/api/playlists/${playlist.id}/playlist', body).then((
      result,
    ) {
  ...
  @override
  Future<void> deletePlaylist(PlaylistView playlist) async => _retry<void>(
    () => _delete(
  ...
  /// GET /api/radio
  @override
  Future<RadioView> radio({Duration? ttl}) async => _retry<RadioView>(
  ...
  /// GET /path -> spiff
  Future<Spiff> spiff(String path, {Duration? ttl}) async => _retry<Spiff>(
  ...
  /// GET /api/movies
  @override
  Future<MoviesView> movies({Duration? ttl}) async => _retry<MoviesView>(
  ...
  Future<GenreView> moviesGenre(String genre, {Duration? ttl}) async =>
      _retry<GenreView>(
        () =>
            _getJson(
                  '/api/movie-genres/${Uri.encodeComponent(genre)}',
                  ttl: ttl,
                )
  ...
  /// GET /api/movies/1
  @override
  Future<MovieView> movie(int id, {Duration? ttl}) async => _retry<MovieView>(
  ...
  /// GET /api/tv
  @override
  Future<TVListView> tvList({Duration? ttl}) async => _retry<TVListView>(
    () => _getJson('/api/tv', ttl: ttl)
  ...
  /// GET /api/tv/series
  @override
  Future<TVShowsView> shows({Duration? ttl}) async => _retry<TVShowsView>(
    () => _getJson('/api/tv/series', ttl: ttl)
  ...
  Future<TVSeriesView> tvSeries(int id, {Duration? ttl}) async =>
      _retry<TVSeriesView>(
        () => _getJson('/api/tv/series/$id', ttl: ttl)
  ...
  Future<TVEpisodeView> tvEpisode(int id, {Duration? ttl}) async =>
      _retry<TVEpisodeView>(
        () => _getJson('/api/tv/episodes/$id', ttl: ttl)
  ...
  Future<ProfileView> profile(int peid, {Duration? ttl}) async =>
      _retry<ProfileView>(
        () => _getJson('/api/profiles/$peid', ttl: ttl)
  ...
  /// GET /api/podcasts
  @override
  Future<PodcastsView> podcasts({Duration? ttl}) async => _retry<PodcastsView>(
  ...
  Future<PodcastsView> podcastsSubscribed({Duration? ttl}) async =>
      _retry<PodcastsView>(
        () => _getJson('/api/podcasts/subscribed', ttl: ttl)
            .then((j) => PodcastsView.fromJson(j))
            .catchError((Object e) => Future<PodcastsView>.error(e)),
      );
  ...
  @override
  Future<void> seriesSubscribe(int id) async => _retry<void>(
    () => _put(
      '/api/series/$id/subscribed',
    ).catchError((Object e) => Future<void>.error(e)),
  );

  /// DELETE /api/series/1/subscribed
  @override
  Future<void> seriesUnsubscribe(int id) async => _retry<void>(
    () => _delete(
      '/api/series/$id/subscribed',
    ).catchError((Object e) => Future<void>.error(e)),
  );
  ...
  /// GET /api/progress
  @override
  Future<ProgressView> progress({Duration? ttl}) async => _retry<ProgressView>(
          ...
          .then((response) {
            ...
            response.listen(
              ...
              onDone: () {
                ...
                sink.flush().whenComplete(
                  () => sink.close().whenComplete(() {
