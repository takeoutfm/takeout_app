...
class ClientCubit extends Cubit<ClientState> {
  ...
  Future<void> code() =>
      _doit<AccessCode>(({Duration? ttl}) => repository.code(),
          ttl: Duration.zero);

  Future<void> checkCode(AccessCode accessCode) =>
      _doit<bool>(({Duration? ttl}) => repository.checkCode(accessCode),
          ttl: Duration.zero);

  Future<void> artists({Duration? ttl}) =>
      _doit<ArtistsView>(({Duration? ttl}) => repository.artists(ttl: ttl),
          ttl: ttl);

  Future<void> artist(int id, {Duration? ttl}) =>
      _doit<ArtistView>(({Duration? ttl}) => repository.artist(id, ttl: ttl),
          ttl: ttl);

  Future<void> artistPlaylist(int id, {Duration? ttl}) =>
  ...
  Future<void> artistRadio(int id, {Duration? ttl}) =>
  ...
  Future<void> shows({Duration? ttl}) =>
      _doit<TVShowsView>(({Duration? ttl}) => repository.shows(ttl: ttl),
          ttl: ttl);

  Future<void> tvList({Duration? ttl}) =>
  ...
  Future<void> radio({Duration? ttl}) =>
      _doit<RadioView>(({Duration? ttl}) => repository.radio(ttl: ttl),
          ttl: ttl);

  Future<void> release(int id, {Duration? ttl}) =>
  ...
  Future<void> trackPlaylist(String id, {Duration? ttl}) =>
      _doit<Spiff>(({Duration? ttl}) => repository.trackPlaylist(id, ttl: ttl),
          ttl: ttl);

  Future<void> search(String query, {Duration? ttl}) =>
      _doit<SearchView>(({Duration? ttl}) => repository.search(query, ttl: ttl),
          ttl: ttl);

  Future<void> series(int id, {Duration? ttl}) =>
  ...
  Future<void> seriesPlaylist(int id, {Duration? ttl}) =>
  ...
  Future<void> station(int id, {Duration? ttl}) =>
      _doit<Spiff>(({Duration? ttl}) => repository.station(id, ttl: ttl),
          ttl: ttl);

  Future<void> index({Duration? ttl}) =>
  ...
  Future<void> playlist({Duration? ttl, int? id}) =>
      _doit<Spiff>(({Duration? ttl}) => repository.playlist(ttl: ttl, id: id),
          ttl: ttl);

  Future<void> playlists({Duration? ttl}) =>
  ...
  Future<void> progress({Duration? ttl}) =>
  ...
  Future<void> podcasts({Duration? ttl}) =>
